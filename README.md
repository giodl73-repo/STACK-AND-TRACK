...
STACK-AND-TRACK is a closed-loop methodology for turning an outcome target into
a credible, prioritized, and continuously improving plan.

```text
Set the target
  -> Stack enough credible impact
  -> Pareto-prioritize
  -> Track predicted and realized gains
  -> Learn from variance
  -> Re-stack
```
...
> Never approve a target without an impact stack that mathematically supports
> it, and prefer substantial over-coverage when feasible.
...
- [High reliability: 99.9% to 99.999%](examples/reliability-99.9-to-99.999.md)
- [Incident management: customer-impact minutes](examples/incident-impact-minutes.md)
- [Fundamentals: recurring engineering loss](examples/fundamentals-recurring-loss.md)
...
- [Measurement quality](guides/measurement-quality.md)
- [Multi-metric outcomes](guides/multi-metric-outcomes.md)
