...
| Example | Outcome shape | Central lesson |
|---|---|---|
| [Performance: 10 seconds to 8 seconds](performance-10-to-8.md) | Additive reduction | Nominal opportunity can exceed 2x while credible coverage remains modest |
| [Reliability: 95% to 99%](reliability-95-to-99.md) | Bounded percentage | Convert availability into downtime and use independent paths near a ceiling |
